...
test('Dashboard with Login', async ({ page }) => {
  ...
  const totalRequestsElement = page
    .locator('text=Total Requests')
    .locator('xpath=../../dd//p')
    .first();
  const activePartnersElement = page
    .locator('text=Active Partners')
    .locator('xpath=../../dd//p')
    .first();
  const pendingAssignmentsElement = page
    .locator('text=Pending Assignments')
    .locator('xpath=../../dd//p')
    .first();
  const completedThisMonthElement = page
    .locator('text=Completed This Month')
    .locator('xpath=../../dd//p')
    .first();
