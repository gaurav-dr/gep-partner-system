...
interface CustomerRequestsQuery {
  status?: string;
  service_type?: string;
  page?: string;
  limit?: string;
...
router.post('/', validateRequest(createRequestSchema), async (req: Request<{}, CustomerRequest, CreateCustomerRequestRequest>, res: Response, next: NextFunction) => {
  try {
...
router.put('/:id', validateRequest(updateRequestSchema), async (req: Request<{ id: string }, CustomerRequest, Partial<CreateCustomerRequestRequest>>, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
router.post('/:id/assign', async (req: Request<{ id: string }, any, AssignmentRequest>, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
router.get('/generate-ai', async (req: Request, res: Response, next: NextFunction) => {
  try {
